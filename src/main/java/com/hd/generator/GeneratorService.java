...
public class GeneratorService {
	...
	// ===================================
	Bean bean = new Bean();
	private static String BEAN_URL = beanLoadProperties.getValue("BEAN_SERVICE_URL");
	...
	public void generateBean(String tableName, List<BeanProperty> beanProperties) throws Exception {
		if (beanProperties != null) {
			...
			String fileName = path + handleTableName(tableName) + "Service.java";
			...
			fw.write(createCode(beanLoadProperties.getValue("BEAN_TEMPLATE_SERVICE_VM_PATH"), bean, annotation, beanProperties));
